...
exports.INITIAL_CHECKPOINTS = void 0;
exports.canAgentProceedToLayer = canAgentProceedToLayer;
exports.INITIAL_CHECKPOINTS = [
    {
        id: 'chk-prd-1',
...
function canAgentProceedToLayer(targetLayer, checkpoints = exports.INITIAL_CHECKPOINTS) {
    // Jika target layer adalah FRONTEND, maka checkpoint layer BACKEND harus approved
    if (targetLayer === 'FRONTEND') {
        const beCheckpoint = checkpoints.find((c) => c.layer === 'BACKEND' && c.type === 'layer_transition');
    ...
    if (targetLayer === 'BACKEND') {
        const dbCheckpoint = checkpoints.find((c) => c.layer === 'DATABASE' && c.type === 'layer_transition');
