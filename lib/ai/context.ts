...
import type { ProjectStack, TaskLayer } from '@/lib/db/database.types';
 ...
 */
export function formatAgentMarkdownPrompt(context: TaskExecutionContext): string {
